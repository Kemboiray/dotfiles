...
class ColorStack:
    ...
    def copy(self, other):
        ...
        self._set(
            fg=other._fg,
            bg=other._bg,
            bright=other._bright,
            bold=other._bold,
            underline=other._underline,
            dim=other._dim,
            reverse=other._reverse,
        )
        return self
...
class Custom(ColorScheme):
    ...
    BROWSER_COLORS = {
        "selected": ColorStack(
            is_bright=True, is_bold=True, is_dim=False, is_reverse=True
        ),  # reverse, fixed colors, underline, etc
        "error": ColorStack(fg=red, is_bright=True, is_bold=True),
        "marked": ColorStack(
            fg=yellow, bg=default, is_bright=True, is_bold=True, is_underline=False
        ),
        "copied": ColorStack(
            fg=black, bg=default, is_bright=True, is_bold=True, is_underline=False
        ),
    ...
    VCS_COLORS = {
        "status": ColorStack(
            is_bright=False, is_bold=False, is_underline=False
        ),  # default
    ...
    STATUS_COLORS = {
        ...
        "marked": ColorStack(
            fg=yellow, is_bright=True, is_bold=True, is_reverse=True
        ),  # Mrk
        ...
        "progress_bar": ColorStack(
            fg=white, bg=blue, is_bright=False, is_dim=False, is_reverse=False
        ),
    }
    ...
    def use(self, context):
        ...
        if context.in_browser:
            ...
            if context.hostname:
                colors.add(
                    self.TITLE_COLORS["hostname_bad"]
                    if context.bad
                    else self.TITLE_COLORS["hostname"]
                )
            elif context.directory:
                ...
                colors.add(
                    self.TITLE_COLORS["tab_good"]
                    if context.good
                    else self.TITLE_COLORS["tab"]
                )
            ...
            if context.permissions:
                colors.add(
                    self.STATUS_COLORS["permissions"]
                    if context.good
                    else self.STATUS_COLORS["permissions_bad"]
                )
            elif context.nlink:
                ...
                colors.add(
                    self.STATUS_COLORS["message_bad"]
                    if context.bad
                    else self.STATUS_COLORS["message"]
                )
            ...
            if context.text:
                colors.add(
                    self.STATUS_COLORS["text_highlight"]
                    if context.highlight
                    else self.STATUS_COLORS["text"]
                )
